...
(function(cornerstone) {
  ...
  function displayImage(element, image, viewport) {
    ...
    if (enabledElement.viewport === undefined) {
      enabledElement.viewport = cornerstone.internal.getDefaultViewport(
    ...
    if (enabledElement.lastImageTimeStamp !== undefined) {
      var timeSinceLastImage =
        now.getTime() - enabledElement.lastImageTimeStamp;
...
(function(cornerstone) {
  ...
  function getImageSize(enabledElement) {
    if (
      ...
      enabledElement.viewport.rotation === 180
    ) {
      return {
...
(function(cornerstone) {
  ...
  function getDefaultViewportForImage(element, image) {
    var enabledElement = cornerstone.getEnabledElement(element);
    var viewport = cornerstone.internal.getDefaultViewport(
      enabledElement.canvas,
      image
    );
    return viewport;
...
(function(cornerstone) {
  ...
  function getPixels(element, x, y, width, height) {
    var storedPixels = cornerstone.getStoredPixels(
      element,
      x,
      y,
      width,
    ...
    var mlutfn = cornerstone.internal.getModalityLUT(
      ee.image.slope,
      ee.image.intercept,
...
(function(cornerstone) {
  ...
  function calculateTransform(enabledElement, scale) {
    ...
    transform.translate(
      -enabledElement.image.width / 2,
      -enabledElement.image.height / 2
    );
    return transform;
  }
...
(function(cornerstone) {
  ...
  function generateLutNew(
    ...
    if (image.lut === undefined) {
      image.lut = new Int16Array(
        image.maxPixelValue - Math.min(image.minPixelValue, 0) + 1
      );
    }
    var lut = image.lut;
    ...
    var vlutfn = cornerstone.internal.getVOILUT(
      windowWidth,
      windowCenter,
      voiLUT
    );
    ...
    for (
      storedValue = image.minPixelValue;
  ...
  function generateLut(
    ...
    if (invert === true) {
      for (
        ...
        voiLutValue =
          ((modalityLutValue - localWindowCenter) / localWindowWidth + 0.5) *
          255.0;
        clampedValue = Math.min(Math.max(voiLutValue, 0), 255);
        lut[storedValue + -offset] = Math.round(255 - clampedValue);
      }
...
(function(cornerstone) {
  ...
  cornerstone.storedPixelDataToCanvasImageData =
    cornerstone.internal.storedPixelDataToCanvasImageData;
  cornerstone.storedColorPixelDataToCanvasImageData =
    cornerstone.internal.storedColorPixelDataToCanvasImageData;
})(cornerstone);
/**
...
(function(cornerstone) {
  ...
  function storedColorPixelDataToCanvasImageData(
    image,
    lut,
    canvasImageDataData
  ) {
    ...
    if (minPixelValue < 0) {
      while (storedPixelDataIndex < numPixels) {
        localCanvasImageDataData[canvasImageDataIndex++] =
          localLut[storedPixelData[storedPixelDataIndex++] + -minPixelValue]; // red
        localCanvasImageDataData[canvasImageDataIndex++] =
          localLut[storedPixelData[storedPixelDataIndex++] + -minPixelValue]; // green
        localCanvasImageDataData[canvasImageDataIndex] =
          localLut[storedPixelData[storedPixelDataIndex] + -minPixelValue]; // blue
      ...
      while (storedPixelDataIndex < numPixels) {
        localCanvasImageDataData[canvasImageDataIndex++] =
          localLut[storedPixelData[storedPixelDataIndex++]]; // red
        localCanvasImageDataData[canvasImageDataIndex++] =
          localLut[storedPixelData[storedPixelDataIndex++]]; // green
        localCanvasImageDataData[canvasImageDataIndex] =
          localLut[storedPixelData[storedPixelDataIndex]]; // blue
        storedPixelDataIndex += 2;
        canvasImageDataIndex += 2;
      }
    }
  ...
  function storedPixelDataToCanvasImageData(image, lut, canvasImageDataData) {
    ...
    if (minPixelValue < 0) {
      while (storedPixelDataIndex < localNumPixels) {
        localCanvasImageDataData[canvasImageDataIndex] =
          localLut[localPixelData[storedPixelDataIndex++] + -minPixelValue]; // alpha
        canvasImageDataIndex += 4;
      }
    } else {
      while (storedPixelDataIndex < localNumPixels) {
        localCanvasImageDataData[canvasImageDataIndex] =
          localLut[localPixelData[storedPixelDataIndex++]]; // alpha
        canvasImageDataIndex += 4;
      }
    }
  }
...
(function(cornerstone) {
  ...
  function initializeColorRenderCanvas(image) {
    ...
    colorRenderCanvasContext.fillRect(
      0,
      0,
      colorRenderCanvas.width,
      colorRenderCanvas.height
    );
    colorRenderCanvasData = colorRenderCanvasContext.getImageData(
      0,
      0,
      image.width,
      image.height
...
(function(cornerstone) {
  ...
  function initializeGrayscaleRenderCanvas(image) {
    ...
    grayscaleRenderCanvasContext.fillRect(
      0,
      0,
      grayscaleRenderCanvas.width,
      grayscaleRenderCanvas.height
    );
    grayscaleRenderCanvasData = grayscaleRenderCanvasContext.getImageData(
      0,
      0,
      image.width,
      image.height
  ...
  function getRenderCanvas(enabledElement, image, invalidated) {
    ...
    cornerstone.storedPixelDataToCanvasImageData(
      image,
      lut,
      grayscaleRenderCanvasData.data
    );
...
(function(cornerstone) {
  ...
  function reset(element) {
    var enabledElement = cornerstone.getEnabledElement(element);
    var defaultViewport = cornerstone.internal.getDefaultViewport(
      enabledElement.canvas,
...
(function(cornerstone) {
  ...
  function setToPixelCoordinateSystem(enabledElement, context, scale) {
    ...
    var transform = cornerstone.internal.calculateTransform(
      enabledElement,
      scale
    );
